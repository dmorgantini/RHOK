...
wot.search = {
    ...
    addImageDiv: function(link, frame) {
        try {
    ...
    processframe: function(rule, frame) {
        try {
            var self = this;
            $('a:contains("@ScottMuc")').each(function() {
                if (!this.getAttribute(self.getattrname("processed"))) {
                    this.setAttribute(self.getattrname("processed"), true);
                    wot.search.addImageDiv(this, frame);
                }
                wot.popup.add(this.parentNode);
            });
    ...
    onclickdonateicon: function(event) {
        try {
            var target =
